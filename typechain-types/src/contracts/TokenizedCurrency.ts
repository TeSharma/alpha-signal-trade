...
export interface TokenizedCurrencyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface TokenizedCurrency extends BaseContract {
  connect(runner?: ContractRunner | null): TokenizedCurrency;
  waitForDeployment(): Promise<this>;

  interface: TokenizedCurrencyInterface;
